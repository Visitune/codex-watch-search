      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-6 grid lg:grid-cols-[1.2fr_0.8fr] gap-4">
          <div className="rounded-2xl bg-white dark:bg-[#131B2C] border border-[#E5E7EB] dark:border-white/[0.06] p-5">
            ...
            <p className="mt-4 text-xs leading-relaxed text-[#6B7280] dark:text-white/60">Distinction PRD §21: <strong>NEW</strong> / <strong>REVISED</strong> / <strong>NEW_TRANSLATION</strong> / <strong>REMOVED</strong>. MVP affiche les récents (LastModified ≥2025). Détection SHA-256 prévue après extraction PDF complète.</p>
          </div>
          <div className="rounded-2xl bg-[#0B1120] dark:bg-[#131B2C] border border-white/10 p-5 text-white relative overflow-hidden">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/70">Recherche <strong className="text-white">MiniSearch + SQLite</strong> (<code>public/search-index.json</code> 185KB + <code>codex.db</code> 100KB) — 0 Postgres, déployable en 30s sur Vercel.</p>
        ...
        <div className="mt-6 rounded-2xl bg-white dark:bg-[#131B2C] border border-[#E5E7EB] dark:border-white/[0.06] p-5">
          ...
          <div className="mt-4 grid gap-2">
            {b.recents.map((d) => (
              <div key={d.Reference} className="rounded-xl border border-[#E5E7EB] dark:border-white/[0.06] bg-[#F8F9FC] dark:bg-[#0B1120] p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div>
